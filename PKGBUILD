...
url="https://github.com/Vioneta/VionetaOS-LocalStorage"
license=('APACHE')
groups=('vionetaos')
backup=('etc/vionetaos/local-storage.conf')
source_x86_64=(
...
package() {
	...
	install -Dm644 "${_sysdir}/etc/vionetaos/${_name}.conf.sample" "${pkgdir}/etc/vionetaos/${_name}.conf"
